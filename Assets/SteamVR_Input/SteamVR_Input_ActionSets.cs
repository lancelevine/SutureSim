...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_NeedleDriver p_NeedleDriver;
        ...
        public static SteamVR_Input_ActionSet_NeedleDriver NeedleDriver
        {
            get
            {
                return SteamVR_Actions.p_NeedleDriver.GetCopy<SteamVR_Input_ActionSet_NeedleDriver>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_NeedleDriver = ((SteamVR_Input_ActionSet_NeedleDriver)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_NeedleDriver>("/actions/NeedleDriver")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.NeedleDriver};
        }
    }
}
